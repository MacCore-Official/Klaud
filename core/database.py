...
class Database:
    ...
    async def connect(self):
        """Establish connection pool with Supabase/PgBouncer fixes."""
        if self.pool:
            return self.pool
        ...
        try:
            # statement_cache_size=0 is REQUIRED for Supabase Transaction mode
    ...
    async def init_tables(self, conn):
        ...
        # This creates the tables the bot needs to function
        await conn.execute("""
